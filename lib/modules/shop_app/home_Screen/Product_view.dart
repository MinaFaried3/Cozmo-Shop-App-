...
class ProductView extends StatelessWidget {
  ...
  ProductView(this.index, this.model);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${model!.data!.products[index].price} .LE',
                          style: TextStyle(
                              color: CozmoColor2,
                              fontSize: 25,
                              fontWeight: FontWeight.w600),
                        ...
                        if (model!.data!.products[index].discount != 0)
                          Text(
                            '${model!.data!.products[index].old_price} .LE',
                            style: TextStyle(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              ShopCubit.get(context)
                                  .ChangeCart(model!.data!.products[index].id);
                            },
                            child: Row(
                              children: [
                                IconButton(
                                  onPressed: () {},
                                  icon: ShopCubit.get(context).cart[
                                          model!.data!.products[index].id]!
                                      ? Icon(
                                ...
                                Text(
                                  "Add Cart",
                                  style: TextStyle(
                                      color: ShopCubit.get(context).cart[
                                              model!.data!.products[index].id]!
                                          ? CozmoColor2
                                          : CozmoText,
                                      fontSize: 20,
